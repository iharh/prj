...
/**
 * A hacked GWT SimpleHtmlSanitizer.
 * There were no other way to expand white list of tags than just rewrite SimpleHtmlSanitizer.
 * <br>
 * Source: <a href=http://code.google.com/p/gwt-examples/wiki/SafeHtml>http://code.google.com/p/gwt-examples/wiki/SafeHtml</a>
 */
public final class SimpleHtmlSanitizerEx implements HtmlSanitizer {
    private static final SimpleHtmlSanitizerEx INSTANCE = new SimpleHtmlSanitizerEx();
    ...
    * @return the instance
    */
    public static SimpleHtmlSanitizerEx getInstance() {
        return INSTANCE;
    }
