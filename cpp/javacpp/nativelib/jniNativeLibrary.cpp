// Generated by JavaCPP version 1.4.2: DO NOT EDIT THIS FILE
...
static void JavaCPP_NativeLibrary_00024NativeClass_deallocate(void *p) { delete (NativeLibrary::NativeClass*)p; }
...
static int JavaCPP_memberOffsetSizes[9] = { 1, 1, 1, 1, 1, 1, 1, 1, 2 };
...
JNIEXPORT void JNICALL Java_NativeLibrary_00024NativeClass_set_1property(JNIEnv* env, jobject obj, jstring arg0) {
...
JNIEXPORT jstring JNICALL Java_NativeLibrary_00024NativeClass_property__(JNIEnv* env, jobject obj) {
    NativeLibrary::NativeClass* ptr = (NativeLibrary::NativeClass*)jlong_to_ptr(env->GetLongField(obj, JavaCPP_addressFID));
    if (ptr == NULL) {
        env->ThrowNew(JavaCPP_getClass(env, 6), "This pointer address is NULL.");
        return 0;
...
JNIEXPORT void JNICALL Java_NativeLibrary_00024NativeClass_property__Ljava_lang_String_2(JNIEnv* env, jobject obj, jstring arg0) {
    NativeLibrary::NativeClass* ptr = (NativeLibrary::NativeClass*)jlong_to_ptr(env->GetLongField(obj, JavaCPP_addressFID));
    if (ptr == NULL) {
        env->ThrowNew(JavaCPP_getClass(env, 6), "This pointer address is NULL.");
        return;
...
JNIEXPORT jstring JNICALL Java_NativeLibrary_00024NativeClass_get_1property(JNIEnv* env, jobject obj) {
    NativeLibrary::NativeClass* ptr = (NativeLibrary::NativeClass*)jlong_to_ptr(env->GetLongField(obj, JavaCPP_addressFID));
    if (ptr == NULL) {
        env->ThrowNew(JavaCPP_getClass(env, 6), "This pointer address is NULL.");
        return 0;
...
JNIEXPORT void JNICALL Java_NativeLibrary_00024NativeClass_allocate(JNIEnv* env, jobject obj) {
    jthrowable exc = NULL;
    try {
        NativeLibrary::NativeClass* rptr = new NativeLibrary::NativeClass();
        jlong rcapacity = 1;
        JavaCPP_initPointer(env, obj, rptr, rcapacity, rptr, &JavaCPP_NativeLibrary_00024NativeClass_deallocate);
    } catch (...) {
        exc = JavaCPP_handleException(env, 7);
    }
