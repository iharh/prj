...
public class ExportSentimentsDialog extends BaseDialogBox {
	...
	dlgPanel.setSpacing(5);
        ...
        exportName.setWidth("450px");
        namePanel.add(exportName);
        alignLeftLabel(labelName);
    ...
    private void alignLeftLabel(InlineLabel label) {
