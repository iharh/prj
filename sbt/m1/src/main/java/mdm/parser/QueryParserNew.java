...
public final class QueryParserNew {
    ...
    // totally - 3 + 3 + 3 + 1 = 10 groups here
	...
	private QueryParserNew() {
	}

        public static String parseAllGroups(String q) {
            return parseAllGroupsInternal(getPattern(), q);
        }

        public static String parseAllGroupsNSW(String q) {
            return parseAllGroupsInternal(getPatternNoSimpleWord(), q);
        }

        public static String parseAllGroupsNUCC(String q) {
            return parseAllGroupsInternal(getPatternNoUnicodeCharClass(), q);
        }

        public static String parseAllGroupsInternal(Pattern p, String q) {
            StringBuilder result = new StringBuilder();

            String query = omitNegated(q);
    ...
    private static Pattern getPattern() {
        if (pattern == null) {
            pattern = Pattern.compile("(" + NR_REGEXP + "|" // CatRefParserImpl.
                    + CATROLLUP_REGEXP_NOT_GROUP + "|"      // CatRollupParser.
                    + MTOKEN_REGEXP_NOT_GROUP + ")|"        // MTokenParser.
    ...
    public static Pattern getPatternNoSimpleWord() {
        if (pattern == null) {
            pattern = Pattern.compile("(" + NR_REGEXP + "|" // CatRefParserImpl.
                    + CATROLLUP_REGEXP_NOT_GROUP + "|"      // CatRollupParser.
                    + MTOKEN_REGEXP_NOT_GROUP + ")|"        // MTokenParser.
    ...
    public static Pattern getPatternNoUnicodeCharClass() {
        if (pattern == null) {
            pattern = Pattern.compile("(" + NR_REGEXP + "|" // CatRefParserImpl.
                    + CATROLLUP_REGEXP_NOT_GROUP + "|"      // CatRollupParser.
                    + MTOKEN_REGEXP_NOT_GROUP + ")|"        // MTokenParser.
