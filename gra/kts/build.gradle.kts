...
tasks {
	...
	doLast {
	    ...
	    fxBenchParseGenCSV("d", "${dirNameReports}/7.5.2.11-7.3.2.0")
	    fxBenchParseGenCSV("e", "${dirNameReports}/7.5.2.13-7.3.2.0")
	    fxBenchParseGenCSV("f", "${dirNameReports}/7.5.2.15-7.3.2.1")
	}
    }
    "hello" {
	doLast {
