/***************************************************************************************************
The TAU measuring apis calls are made in this module. There are 126 instrumented MPI routines here.
The instrumented version of the routines use PMPI interface provided by MSMPI.
****************************************************************************************************/

#define TAU_WINDOWS
#define TAU_ENABLE_MPI_WTIME
#define TAU_MPI_THREADED
...
int  MPIAPI HMPI_Allgather( sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm )
void * sendbuf;
int sendcount;
...
int  MPIAPI HMPI_Allgatherv( sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, recvtype, comm )
void * sendbuf;
int sendcount;
MPI_Datatype sendtype;
void * recvbuf;
...
int  MPIAPI HMPI_Allreduce( sendbuf, recvbuf, count, datatype, op, comm )
void * sendbuf;
void * recvbuf;
int count;
...
int MPIAPI HMPI_Alltoall( sendbuf, sendcount, sendtype, recvbuf, recvcnt, recvtype, comm )
void * sendbuf;
int sendcount;
MPI_Datatype sendtype;
void * recvbuf;
...
int  MPIAPI HMPI_Alltoallv( sendbuf, sendcnts, sdispls, sendtype, recvbuf, recvcnts, rdispls, recvtype, comm )
void * sendbuf;
int * sendcnts;
int * sdispls;
MPI_Datatype sendtype;
...
int  MPIAPI HMPI_Bcast( buffer, count, datatype, root, comm )
void * buffer;
int count;
MPI_Datatype datatype;
int root;
...
int  MPIAPI HMPI_Gather( sendbuf, sendcnt, sendtype, recvbuf, recvcount, recvtype, root, comm )
void * sendbuf;
int sendcnt;
MPI_Datatype sendtype;
void * recvbuf;
...
int  MPIAPI HMPI_Gatherv( sendbuf, sendcnt, sendtype, recvbuf, recvcnts, displs, recvtype, root, comm )
void * sendbuf;
int sendcnt;
MPI_Datatype sendtype;
...
int MPIAPI HMPI_Op_create( function, commute, op )
...
int  MPIAPI HMPI_Reduce_scatter( sendbuf, recvbuf, recvcnts, datatype, op, comm )
void * sendbuf;
void * recvbuf;
int * recvcnts;
MPI_Datatype datatype;
...
int  MPIAPI HMPI_Reduce( sendbuf, recvbuf, count, datatype, op, root, comm )
void * sendbuf;
void * recvbuf;
int count;
MPI_Datatype datatype;
...
int  MPIAPI HMPI_Scan( sendbuf, recvbuf, count, datatype, op, comm )
void * sendbuf;
void * recvbuf;
int count;
MPI_Datatype datatype;
...
int  HMPI_Scatter( sendbuf, sendcnt, sendtype, recvbuf, recvcnt, recvtype, root, comm )
void * sendbuf;
int sendcnt;
MPI_Datatype sendtype;
void * recvbuf;
...
int  HMPI_Scatterv( sendbuf, sendcnts, displs, sendtype, recvbuf, recvcnt, recvtype, root, comm )
void * sendbuf;
int * sendcnts;
int * displs;
MPI_Datatype sendtype;
...
int  MPIAPI HMPI_Attr_delete( comm, keyval )
MPI_Comm comm;
int keyval;
{
  int   returnVal;
...
int  MPIAPI HMPI_Attr_get( comm, keyval, attr_value, flag )
MPI_Comm comm;
int keyval;
void * attr_value;
int * flag;
...
int  MPIAPI HMPI_Attr_put( comm, keyval, attr_value )
MPI_Comm comm;
int keyval;
void * attr_value;
{
...
int  MPIAPI HMPI_Comm_compare( comm1, comm2, result )
MPI_Comm comm1;
MPI_Comm comm2;
int * result;
{
...
int  MPIAPI HMPI_Comm_create( comm, group, comm_out )
MPI_Comm comm;
MPI_Group group;
MPI_Comm * comm_out;
{
...
int  MPIAPI HMPI_Comm_dup( comm, comm_out )
MPI_Comm comm;
MPI_Comm * comm_out;
{
  int   returnVal;
...
int  MPIAPI HMPI_Comm_free( comm )
MPI_Comm * comm;
{
  int   returnVal;
...
int  MPIAPI HMPI_Comm_group( comm, group )
MPI_Comm comm;
MPI_Group * group;
{
  int   returnVal;
...
int  MPIAPI HMPI_Comm_rank( comm, rank )
MPI_Comm comm;
int * rank;
{
  int   returnVal;
  //DBG_TR_MPI("Intercept Before");
  ...
  //DBG_TR_MPI("Intercept After");  
  return returnVal;
}

int  MPIAPI HMPI_Comm_remote_group( comm, group )
MPI_Comm comm;
MPI_Group * group;
{
  int   returnVal;
...
int  MPIAPI HMPI_Comm_remote_size( comm, size )
MPI_Comm comm;
int * size;
{
  int   returnVal;
...
int  MPIAPI HMPI_Comm_size( comm, size )
MPI_Comm comm;
int * size;
{
  int   returnVal;
...
int  MPIAPI HMPI_Comm_split( comm, color, key, comm_out )
MPI_Comm comm;
int color;
int key;
MPI_Comm * comm_out;
...
int  MPIAPI HMPI_Comm_test_inter( comm, flag )
MPI_Comm comm;
int * flag;
{
  int   returnVal;
...
int  MPIAPI HMPI_Group_compare( group1, group2, result )
MPI_Group group1;
MPI_Group group2;
int * result;
{
...
int  MPIAPI HMPI_Group_difference( group1, group2, group_out )
MPI_Group group1;
MPI_Group group2;
MPI_Group * group_out;
{
...
int  MPIAPI HMPI_Group_excl( group, n, ranks, newgroup )
MPI_Group group;
int n;
int * ranks;
MPI_Group * newgroup;
...
int  MPIAPI HMPI_Group_free( group )
MPI_Group * group;
{
  int   returnVal;
...
int  MPIAPI HMPI_Group_incl( group, n, ranks, group_out )
MPI_Group group;
int n;
int * ranks;
MPI_Group * group_out;
...
int  MPIAPI HMPI_Group_intersection( group1, group2, group_out )
MPI_Group group1;
MPI_Group group2;
MPI_Group * group_out;
{
...
int  MPIAPI HMPI_Group_rank( group, rank )
MPI_Group group;
int * rank;
{
  int   returnVal;
...
int  MPIAPI HMPI_Group_range_excl( group, n, ranges, newgroup )
MPI_Group group;
int n;
int ranges[][3];
MPI_Group * newgroup;
...
int  MPIAPI HMPI_Group_range_incl( group, n, ranges, newgroup )
MPI_Group group;
int n;
int ranges[][3];
MPI_Group * newgroup;
...
int  MPIAPI HMPI_Group_size( group, size )
MPI_Group group;
int * size;
{
  int   returnVal;
...
int  MPIAPI HMPI_Group_translate_ranks( group_a, n, ranks_a, group_b, ranks_b )
MPI_Group group_a;
int n;
int * ranks_a;
MPI_Group group_b;
...
int  MPIAPI HMPI_Group_union( group1, group2, group_out )
MPI_Group group1;
MPI_Group group2;
MPI_Group * group_out;
{
...
int  MPIAPI HMPI_Intercomm_create( local_comm, local_leader, peer_comm, remote_leader, tag, comm_out )
MPI_Comm local_comm;
int local_leader;
MPI_Comm peer_comm;
int remote_leader;
...
int  MPIAPI HMPI_Intercomm_merge( comm, high, comm_out )
MPI_Comm comm;
int high;
MPI_Comm * comm_out;
{
...
int  MPIAPI HMPI_Keyval_create( copy_fn, delete_fn, keyval, extra_state )
...
int  MPIAPI HMPI_Keyval_free( keyval )
int * keyval;
{
  int   returnVal;
...
#else
int MPIAPI HMPI_Abort( comm, errorcode )
MPI_Comm comm;
int errorcode;
...
int MPIAPI HMPI_Error_class( errorcode, errorclass )
int errorcode;
int * errorclass;
{
  int  returnVal;
...
int MPIAPI HMPI_Errhandler_create( function, errhandler )
...
int MPIAPI HMPI_Errhandler_free( errhandler )
MPI_Errhandler * errhandler;
{
  int  returnVal;
...
int MPIAPI HMPI_Errhandler_get( comm, errhandler )
MPI_Comm comm;
MPI_Errhandler * errhandler;
{
  int  returnVal;
...
int MPIAPI HMPI_Error_string( errorcode, string, resultlen )
int errorcode;
char * string;
int * resultlen;
{
...
int MPIAPI HMPI_Errhandler_set( comm, errhandler )
MPI_Comm comm;
MPI_Errhandler errhandler;
{
  int  returnVal;
...
int MPIAPI HMPI_Get_processor_name( name, resultlen )
char * name;
int * resultlen;
{
  int  returnVal;
...
int MPIAPI HMPI_Init_thread (argc, argv, required, provided )
int * argc;
char *** argv;
int required;
int *provided;
...
/*
int MPIAPI HMPI_Initialized( flag )
int * flag;
{
  int  returnVal;
...
int MPIAPI HMPI_Address( location, address )
void * location;
MPI_Aint * address;
{
  int  returnVal;
...
int MPIAPI HMPI_Bsend( buf, count, datatype, dest, tag, comm )
void * buf;
int count;
MPI_Datatype datatype;
int dest;
...
int MPIAPI HMPI_Bsend_init( buf, count, datatype, dest, tag, comm, request )
void * buf;
int count;
MPI_Datatype datatype;
int dest;
...
int MPIAPI HMPI_Buffer_attach( buffer, size )
void * buffer;
int size;
{
  int  returnVal;
...
int MPIAPI HMPI_Buffer_detach( buffer, size )
void * buffer;
int * size;
{
  int  returnVal;
...
int MPIAPI HMPI_Cancel( request )
MPI_Request * request;
{
  int  returnVal;
...
int MPIAPI HMPI_Request_free( request )
MPI_Request * request;
{
  int  returnVal;
...
int MPIAPI HMPI_Recv_init( buf, count, datatype, source, tag, comm, request )
void * buf;
int count;
MPI_Datatype datatype;
int source;
...
int MPIAPI HMPI_Send_init( buf, count, datatype, dest, tag, comm, request )
void * buf;
int count;
MPI_Datatype datatype;
int dest;
...
int  MPIAPI HMPI_Get_elements( status, datatype, elements )
MPI_Status * status;
MPI_Datatype datatype;
int * elements;
{
...
int MPIAPI HMPI_Get_count( status, datatype, count )
MPI_Status * status;
MPI_Datatype datatype;
int * count;
{
...
int MPIAPI HMPI_Ibsend( buf, count, datatype, dest, tag, comm, request )
void * buf;
int count;
MPI_Datatype datatype;
int dest;
...
int MPIAPI HMPI_Iprobe( source, tag, comm, flag, status )
int source;
int tag;
MPI_Comm comm;
int * flag;
...
int MPIAPI HMPI_Irecv( buf, count, datatype, source, tag, comm, request )
void * buf;
int count;
MPI_Datatype datatype;
int source;
...
int MPIAPI HMPI_Irsend( buf, count, datatype, dest, tag, comm, request )
void * buf;
int count;
MPI_Datatype datatype;
int dest;
...
int MPIAPI HMPI_Isend( buf, count, datatype, dest, tag, comm, request )
void * buf;
int count;
MPI_Datatype datatype;
int dest;
...
int MPIAPI HMPI_Issend( buf, count, datatype, dest, tag, comm, request )
void * buf;
int count;
MPI_Datatype datatype;
int dest;
...
int  MPIAPI HMPI_Pack( inbuf, incount, type, outbuf, outcount, position, comm )
void * inbuf;
int incount;
MPI_Datatype type;
void * outbuf;
...
int  MPIAPI HMPI_Pack_size( incount, datatype, comm, size )
int incount;
MPI_Datatype datatype;
MPI_Comm comm;
int * size;
...
int MPIAPI HMPI_Probe( source, tag, comm, status )
int source;
int tag;
MPI_Comm comm;
MPI_Status * status;
...
int MPIAPI HMPI_Recv( buf, count, datatype, source, tag, comm, status )
void * buf;
int count;
MPI_Datatype datatype;
int source;
...
int MPIAPI HMPI_Rsend( buf, count, datatype, dest, tag, comm )
void * buf;
int count;
MPI_Datatype datatype;
int dest;
...
int MPIAPI HMPI_Rsend_init( buf, count, datatype, dest, tag, comm, request )
void * buf;
int count;
MPI_Datatype datatype;
int dest;
...
int MPIAPI HMPI_Send( buf, count, datatype, dest, tag, comm )
void * buf;
int count;
MPI_Datatype datatype;
int dest;
...
int MPIAPI HMPI_Sendrecv( sendbuf, sendcount, sendtype, dest, sendtag, recvbuf, recvcount, recvtype, source, recvtag, comm, status )
void * sendbuf;
int sendcount;
MPI_Datatype sendtype;
int dest;
...
int MPIAPI HMPI_Sendrecv_replace( buf, count, datatype, dest, sendtag, source, recvtag, comm, status )
void * buf;
int count;
MPI_Datatype datatype;
int dest;
...
int MPIAPI HMPI_Ssend( buf, count, datatype, dest, tag, comm )
void * buf;
int count;
MPI_Datatype datatype;
int dest;
...
int MPIAPI HMPI_Ssend_init( buf, count, datatype, dest, tag, comm, request )
void * buf;
int count;
MPI_Datatype datatype;
int dest;
...
#ifdef TAU_TRACK_MSG
  /* fix up the request sinceMPIAPI HMPI_Start may (will) change it */
  rq->request = *request;
#endif /* TAU_TRACK_MSG */
...
int MPIAPI HMPI_Startall( count, array_of_requests )
int count;
...
int  MPIAPI HMPI_Test( request, flag, status )
MPI_Request * request;
int * flag;
MPI_Status * status;
{
...
int MPIAPI HMPI_Testall( count, array_of_requests, flag, array_of_statuses )
int count;
MPI_Request * array_of_requests;
int * flag;
...
int MPIAPI HMPI_Testany( count, array_of_requests, index, flag, status )
int count;
MPI_Request * array_of_requests;
int * index;
int * flag;
...
int MPIAPI HMPI_Test_cancelled( status, flag )
MPI_Status * status;
int * flag;
{
  int  returnVal;
...
int MPIAPI HMPI_Testsome( incount, array_of_requests, outcount, array_of_indices, array_of_statuses )
int incount;
MPI_Request * array_of_requests;
int * outcount;
...
int  MPIAPI HMPI_Type_commit( datatype )
MPI_Datatype * datatype;
{
  int   returnVal;
...
int MPIAPI HMPI_Type_contiguous( count, old_type, newtype )
int count;
...
int MPIAPI HMPI_Type_extent( datatype, extent )
MPI_Datatype datatype;
MPI_Aint * extent;
{
  int  returnVal;
...
int  MPIAPI HMPI_Type_free( datatype )
MPI_Datatype * datatype;
{
  int   returnVal;
...
int MPIAPI HMPI_Type_hindexed( count, blocklens, indices, old_type, newtype )
int count;
int * blocklens;
MPI_Aint * indices;
MPI_Datatype old_type;
...
int MPIAPI HMPI_Type_hvector( count, blocklen, stride, old_type, newtype )
int count;
int blocklen;
MPI_Aint stride;
MPI_Datatype old_type;
...
int MPIAPI HMPI_Type_indexed( count, blocklens, indices, old_type, newtype )
int count;
int * blocklens;
int * indices;
MPI_Datatype old_type;
...
int  MPIAPI HMPI_Type_lb( datatype, displacement )
MPI_Datatype datatype;
...
int  MPIAPI HMPI_Type_size( datatype, size )
MPI_Datatype datatype;
int * size;
{
  int   returnVal;
...
int MPIAPI HMPI_Type_struct( count, blocklens, indices, old_types, newtype )
int count;
int * blocklens;
MPI_Aint * indices;
...
int  MPIAPI HMPI_Type_ub( datatype, displacement )
MPI_Datatype datatype;
MPI_Aint * displacement;
{
  int   returnVal;
...
int MPIAPI HMPI_Type_vector( count, blocklen, stride, old_type, newtype )
int count;
int blocklen;
int stride;
MPI_Datatype old_type;
...
int  MPIAPI HMPI_Unpack( inbuf, insize, position, outbuf, outcount, type, comm )
void * inbuf;
int insize;
int * position;
void * outbuf;
...
int  MPIAPI HMPI_Wait( request, status )
MPI_Request * request;
MPI_Status * status;
{
  int   returnVal;
...
int MPIAPI HMPI_Waitall( count, array_of_requests, array_of_statuses )
int count;
MPI_Request * array_of_requests;
MPI_Status * array_of_statuses;
{
...
int MPIAPI HMPI_Waitany( count, array_of_requests, index, status )
int count;
MPI_Request * array_of_requests;
int * index;
MPI_Status * status;
...
int MPIAPI HMPI_Waitsome( incount, array_of_requests, outcount, array_of_indices, array_of_statuses )
int incount;
MPI_Request * array_of_requests;
int * outcount;
int * array_of_indices;
...
int  MPIAPI HMPI_Cart_coords( comm, rank, maxdims, coords )
MPI_Comm comm;
int rank;
int maxdims;
int * coords;
...
int  MPIAPI HMPI_Cart_create( comm_old, ndims, dims, periods, reorder, comm_cart )
MPI_Comm comm_old;
int ndims;
int * dims;
int * periods;
...
int  MPIAPI HMPI_Cart_get( comm, maxdims, dims, periods, coords )
MPI_Comm comm;
int maxdims;
int * dims;
int * periods;
...
int  MPIAPI HMPI_Cart_map( comm_old, ndims, dims, periods, newrank )
MPI_Comm comm_old;
int ndims;
int * dims;
int * periods;
...
int  MPIAPI HMPI_Cart_rank( comm, coords, rank )
MPI_Comm comm;
int * coords;
int * rank;
{
...
int  MPIAPI HMPI_Cart_shift( comm, direction, displ, source, dest )
MPI_Comm comm;
int direction;
int displ;
int * source;
...
int  MPIAPI HMPI_Cart_sub( comm, remain_dims, comm_new )
MPI_Comm comm;
int * remain_dims;
MPI_Comm * comm_new;
{
...
int  MPIAPI HMPI_Cartdim_get( comm, ndims )
MPI_Comm comm;
int * ndims;
{
  int   returnVal;
...
int MPIAPI HMPI_Dims_create( nnodes, ndims, dims )
int nnodes;
int ndims;
int * dims;
{
...
int  MPIAPI HMPI_Graph_create( comm_old, nnodes, index, edges, reorder, comm_graph )
MPI_Comm comm_old;
int nnodes;
int * index;
int * edges;
...
int  MPIAPI HMPI_Graph_get( comm, maxindex, maxedges, index, edges )
MPI_Comm comm;
int maxindex;
int maxedges;
int * index;
...
int  MPIAPI HMPI_Graph_map( comm_old, nnodes, index, edges, newrank )
MPI_Comm comm_old;
int nnodes;
int * index;
int * edges;
...
int  MPIAPI HMPI_Graph_neighbors( comm, rank, maxneighbors, neighbors )
MPI_Comm comm;
int rank;
int  maxneighbors;
int * neighbors;
...
int  MPIAPI HMPI_Graph_neighbors_count( comm, rank, nneighbors )
MPI_Comm comm;
int rank;
int * nneighbors;
{
...
int  MPIAPI HMPI_Graphdims_get( comm, nnodes, nedges )
MPI_Comm comm;
int * nnodes;
int * nedges;
{
...
int  MPIAPI HMPI_Topo_test( comm, top_type )
MPI_Comm comm;
int * top_type;
{
  int   returnVal;
